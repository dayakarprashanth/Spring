...
public class CreateDemo {
	...
	public static void main(String[] args) {
		...
		try {
			...
			Instructor tempInstructor = new Instructor("Hari","Krishnan","hari@gmail.com");
			
			InstructorDetail tempInstructorDetail = new InstructorDetail("http://hari/youtube","Gaming");
